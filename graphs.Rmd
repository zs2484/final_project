...
*Firstly, we mapped two bubble maps to see how air transportation is affected by comparing the flight amount since the middle of March with the number of total COVID-19 cases by states. Percent of baseline is the amount of flight compared to the baseline flight amount,  which makes the data easier to understand and compare.*
